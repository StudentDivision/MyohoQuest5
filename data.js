...
const AREAS = [
  {
    ...
    hp: 70,
    doubt: "知らないことへの不安",
    intro: "古い森に、学ぶことを恐れさせる黒い霧が広がっている。",
    bossLine: "知らないままでいいじゃないか。学んでも、世界は何も変わらないさ。",
    clearText: "森を覆っていた霧が晴れ、妙法の光が木々の間に差し込んだ。",
    learn: [
      "日蓮大聖人の御生涯",
      "南無妙法蓮華経の基本",
      "一生成仏という希望"
  ...
  },
  {
    ...
    hp: 75,
    doubt: "行動できない弱さ",
    intro: "道場の扉は重く閉ざされ、挑戦する心をくじく声が響いている。",
    bossLine: "動いたって疲れるだけさ。逃げていれば傷つかずにすむよ。",
    clearText: "道場の扉が開き、小さな一歩を踏み出す勇気が戻ってきた。",
    learn: [
      "三証で確かめる姿勢",
      "信行学を一体で進めること",
      "困難を成長へ変える実践"
  ...
  },
  {
    ...
    intro: "静かな湖面に、不安な心だけが大きく映し出されている。",
    bossLine: "君なんて、たいした価値はない。そう思ってしまえば楽だろう？",
    clearText: "湖面は澄みわたり、すべての生命に宿る可能性を映し始めた。",
    learn: [
      "十界と生命の状態",
      "十界互具が示す可能性",
      "依正不二の見方"
  ...
  },
  {
    ...
    hp: 80,
    doubt: "使命を忘れる心",
    intro: "広い大地に、忘れかけた使命の声が小さく眠っている。",
    bossLine: "使命なんて重いだけだ。自分のことだけ考えていればいい。",
    clearText: "大地から新しい風が起こり、胸の奥に使命の灯がともった。",
    learn: [
      "地涌の菩薩の使命",
      "御書根本の姿勢",
      "善知識を大切にすること"
  ...
  },
  {
    ...
    hp: 85,
    doubt: "人とつながれない慢心",
    intro: "港には霧が立ちこめ、遠くへ伸びる航路が見えなくなっている。",
    bossLine: "人とつながる必要などない。自分だけ正しければ、それで十分だ。",
    clearText: "港の霧が晴れ、平和と励ましを運ぶ航路が光り始めた。",
    learn: [
      "広宣流布の意味",
      "仏教の人間主義",
      "世界へ広がる励ましの連帯"
  ...
  },
  {
    ...
    hp: 85,
    doubt: "受け継がれた精神を忘れる心",
    intro: "記念館の灯火が、忘却の風に揺らめいている。",
    bossLine: "歴史なんて古いだけだ。受け継ぐものなど、もう何もない。",
    clearText: "記念館の灯火は再び強く輝き、師弟の歩みを照らし出した。",
    learn: [
      "創価学会の創立",
      "三代会長の歩み",
      "平和と信念を受け継ぐ心"
  ...
  },
  {
    ...
    intro: "すべての迷いが集まる塔。希望の武器を胸に、最後の戦いへ向かう。",
    bossLine: "人間など変われぬ。希望など、すぐに消える幻にすぎない。",
    clearText: "塔を覆う闇は晴れ、学びと励ましの光が世界へ広がっていった。",
    learn: [
      "教学は人を励ます知恵",
      "一人の変革が未来を開くこと",
      "迷いに負けない希望の心"
...
const STORY_TEXTS = {
  ...
  beforeFinal: [
    ...
    "ソラは少し震えながらも、前を向いた。",
    "「こわいです…でも、ここまで学んできたことは、きっと力になります。最後まで、一緒に進みましょう。」"
  ],
  ending: [
  ...
  endingAfterword: [
    ...
    "希望の武器は、主人公の中にある。そして、次に励ますべき一人のもとへ、新しい一歩が始まる。"
  ]
};
...
const BATTLE_WORDS = {
  ...
  reviewButton: "復習する",
  finalButton: "最終決戦へ",
  rewardText: "希望の武器を手に入れた！",
  learnedText: "今回学んだこと",
  correctPrefix: "ソラ",
  bossPrefix: "ボス",
  nameInputTitle: "冒険者の名を刻め",
