...
const BUDDY_LINES = {
  start: [
    "えっと…大丈夫です。少しずつ覚えていきましょう。",
    "一つ学ぶたびに、迷いの霧が少し晴れていきます…！",
    "こわくても大丈夫です。私も一緒にいます。",
    "教学は、人を責めるためじゃなくて、励ますための知恵なんです。",
    "焦らなくて大丈夫です。目の前の一問から、進んでいきましょう。",
    "小さな一歩でも、ちゃんと希望につながっています…！"
  ],
  correct: [
    "その通りです…！ 知ることは、迷いを晴らす一歩です。",
    "すごいです…！ 今の問題、とても大事なところです。",
    "やりました…！ 希望の光が少し強くなりました。",
    "正解です。ちゃんと前に進めています…！",
    "今の答え、きっと誰かを励ます力になります。",
    "一つ分かっただけで、心が少し強くなりますね…！"
  ],
  wrong: [
    "大丈夫です。今覚えれば、それが前進です…！",
    "間違えても大丈夫です。覚え直せば、きっと力になります。",
    "えっと…焦らなくて大丈夫です。一緒にもう一度考えましょう。",
    "失敗じゃありません。次に希望をつなげるための一歩です。",
    "迷いに少し揺れても、また立ち上がれば大丈夫です。",
    "この問題に出会えたことも、きっと学びになります…！"
  ],
  victory: [
    "すごいです…！ また一つ、教学の力が増えましたね。",
    "迷いの霧が晴れていきます。やりました…！",
    "一つ学んで、一つ強くなれましたね。",
    "この知恵は、きっと誰かを励ます力になります。",
    "こわかったけど…一緒に進めて、よかったです。",
    "希望の武器が増えました。次の迷いにも、きっと向き合えます。"
  ],
  defeat: [
    "えっと…大丈夫です。何度でも挑戦できます。",
    "間違えたところを覚え直せば、きっと前に進めます。",
    "迷いは強いけれど、学ぶ心は消えません…！",
    "少し休んだら、また一緒に進みましょう。",
    "負けても終わりじゃありません。もう一度立ち上がれます。",
    "ここまで進んだことも、ちゃんと力になっています…！"
  ],
  boss: [
    "迷いの声が強くなっています…でも、きっと大丈夫です。",
    "こわいです…でも、ここまで学んできたことを信じましょう。",
    "焦らなくて大丈夫です。一問ずつ、心をこめて答えましょう。",
    "迷いに飲まれそうな時こそ、希望の言葉を思い出しましょう。",
    "私も一緒にいます。最後まで、あきらめずに進みましょう。",
    "ここまで来られました。きっと、もう少しです…！"
  ],
  final: [
    "第六天の魔王の声は強いです…でも、人は変われます。",
    "迷いは心を閉じ込めます。でも教学は、心を開く鍵になります。",
    "ここまで学んできた全部が、今の力になります…！",
    "最後まで一緒です。希望の光を、消させません。",
    "人の生命をあきらめないこと…それが、私たちの答えです。",
    "こわいけれど…それでも進みましょう。希望は、きっとあります。"
  ],
  review: [
    "復習ですね。えっと…前より少し強くなれる時間です。",
    "間違えた問題は、宝物みたいなものです。伸びる場所が分かりますから。",
    "大丈夫です。もう一度出会えば、きっと覚えられます。",
    "焦らず、ひとつずつ取り戻していきましょう。",
    "復習する気持ち、とても大切だと思います…！",
    "一度間違えた問題も、次は希望の力に変えられます。"
  ]
};
